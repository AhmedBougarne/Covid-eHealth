          ...
          <div class="item active">
            ...
            <div class="carousel-caption">
             <div id="cb" class="login-dark">
                <form method="post" action="3.2logPatInf.php">
                <?php
                         session_start();
                          ...
                          $id12=$_POST['id'];
                          $_SESSION["x"]=$id12;
                          $sql="SELECT * FROM patient WHERE nom='$nom' AND prenom = '$prenom' AND ID = '$id12'";
                          $run_query=mysqli_query($conn,$sql);
                          $count=mysqli_num_rows($run_query);
                          
                          if($count>0){ 
                              echo "<script>alert('Le patient $prenom $nom est bien inscrit d'avance')</script>";
                              header('Location:http://localhost/boostrap%20fich1/3.3checksym.php');
                              exit;

                          }
                          else{
                              echo "<p class='alert alert-danger'>nom ou prenom sont incorrecte  </p>";

            ...
            <div class="item active">
              ...
              <div class="carousel-caption">
               <div id="cb" class="login-dark">
                  ...
                  <form method="POST" action="4.4.2testPCR2.php">
                  <?php
//test PCR
...
$sql = "UPDATE affectation SET TestPCR='$testPCR' WHERE idAffect=$idA";
$run_query=mysqli_query($conn,$sql);
if($run_query){
  echo "<script>alert('Success!')</script>";
  header('Location:http://localhost/boostrap%20fich1/4.4.3TDM2.php');
       exit;
}
else{
...
?>
                     <div id="soutitre" ><h3>Le test PCR</h3></div>
                        <br>
                        <br>
                        <div class="form-group">     
                      <div class="form-check">
                            <input class="form-check-input" type="radio" name="rbtn" id="exampleRadios1" value="positif">
                         ...
                         <br>
                         <div class="form-check">
                            <input class="form-check-input" type="radio" name="rbtn" id="exampleRadios2" value="negatif">
                          ...
                          <br>   
                          <br>
                          <button class="btn btn-primary btn-block" type="submit" name="submit2">enregistrer</button>
                     </div>
                   </form>  
                </div>

            ...
            <div class="item active">
              ...
              <div class="carousel-caption">
               <div id="cb" class="login-dark">
                  ...
                  <form method="POST" action="6.2insripaAG.php">
                  <?php
                // Create connection
                ...
                if(isset($_POST['submit'])){
                 ...
                 if($nom==""||$prenom==""||$cni==""){
                   ...
                   Remplissez toutes les cases  <a href='http://127.0.0.1:5500/6.2insripaAG.html'>return now</a>
                 </p>";
                   }
                   else{
                        ...
                        $_SESSION["id"] =$row['nbrlignes']+1;
                         $id10= $_SESSION["id"];
                       $sql = "INSERT INTO patient (nom,prenom,telephone,nationalite,CNI,date_naissance,email,dateInscription) VALUES ('$nom','$prenom','$telephone','$nationality','$cni','$birthday','$email','$date')";
                       $run_query=mysqli_query($conn,$sql);
                          if($run_query){
                            echo "<p class='alert alert-success'>
                            l'identifiant du patient est: $id10 <a href='http://127.0.0.1:5500/6.1newpatAG.html'>retourner</a>
                          </p>";
                              echo "<script>alert('the patient $prenom $nom  has been added successfully! on the  $date')</script>";
                              
                          }else{
                                echo "<script>alert('error in the sign up')</script>";
                                }
                       } 
                }
                mysqli_close($conn);
                ?> 
                    <div id="soutitre" ><h3>les coordonnées du patient</h3></div>
                <div class="form-group">
                  <input type="text" class="form-control"  name="nom" id="inputAddress" placeholder="nom ">
                  <input type="text" class="form-control"  name="prenom" id="inputAddress" placeholder="prenom ">
                  ...
                  <input type="text" class="form-control"  name="id"  placeholder="numéro d'identité">
                  <input type="date" class="form-control"  name="birthday"  placeholder="date de naissance"> 
                  <br>   
                  <div class="form-group"> <input type="submit" name="submit" value="Sign Up" class="btn btn-primary"></div>
               </div>  
            </form>
          </div>
       </div>

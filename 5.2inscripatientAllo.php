            ...
            <div class="item active">
              ...
              <div class="carousel-caption">
               <div id="cb" class="login-dark">
                  ...
                  <form method="POST" action="5.2inscripatientAllo.php">
                  <?php
                // Create connection
                 ...
                 if($nom==""||$prenom==""||$cni==""){
                   ...
                   Remplissez toutes les cases  
                       ...
                       $run_query=mysqli_query($conn,$sql);
                          if($run_query){
                              echo "<script>alert('the patient $prenom $nom  has been added successfully! in  $date')</script>";
                              header('Location:http://localhost/boostrap%20fich1/5.3checksymAl.php');
                              exit;
                          }else{
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="cni"  placeholder="numéro d'identité">

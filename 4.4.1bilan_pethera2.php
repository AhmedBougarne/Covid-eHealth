            ...
            <div class="item active">
              ...
              <div class="carousel-caption">
               <div id="cb" class="login-dark">
                  ...
                  <form method="POST" action="4.4.1bilan_pethera2.php">
                  <?php
                      //Bilan pétherapeutique
                       ...
                       $sql = "INSERT INTO affectation (idAffect,NFS,CRP,LDH) VALUES ('$idAff','$NFS','$CRP','$LDH')";
                       $run_query=mysqli_query($conn,$sql);
                       if($run_query){
                                echo "<script>alert('Success!')</script>";
                                header('Location:http://localhost/boostrap%20fich1/4.4.2testPCR2.php');
                                     exit;
                       }
                      else{
                 ...
                 ?>
                         ...
                         <h5><i>Le patient est en état instable</i></h5>
                           <br>
                          <div id="soutitre" ><h3>Bilan pétherapeutique</h3></div>
                          
                          <div class="form-group">

                            <input  class="form-control"  name=" NFS" id="inputAddress" placeholder="saisir son NFS">
                            <br>
                            <input  class="form-control"  name=" CRP"  placeholder="saisir son CRP">
                            <br>
                            <input class="form-control" type="" name="LDH" placeholder="saisir son LDH"> 
                            <br>  
                           
                            <button class="btn btn-primary btn-block" type="submit" name="submit1">enregistrer</button>
                       </div>
                   </form>  
                </div>
